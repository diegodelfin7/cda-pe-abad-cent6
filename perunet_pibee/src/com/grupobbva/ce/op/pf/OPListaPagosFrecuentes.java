...
public class OPListaPagosFrecuentes.java extends OperacionPresentacion
{
  public OPListaPagosFrecuentes.java()
  {
  }

  public OPListaPagosFrecuentes.java(String anOperationName)
    throws IOException
  {
    super(anOperationName);
  }

  public OPListaPagosFrecuentes.java(String anOperationName, Context aParentContext)
    throws IOException, DSEInvalidRequestException
  {
    super(anOperationName, aParentContext);
  }

  public OPListaPagosFrecuentes.java(String anOperationName, String aParentContext)
  ...
  public void getPagosFrecuentes() throws BbvaException
  {
    try {
