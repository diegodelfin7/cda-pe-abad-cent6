...
public class OPInscripcionCCI extends OperacionPresentacion
{
  public OPInscripcionCCI()
  {
  }

  public OPInscripcionCCI(String anOperationName)
    throws IOException
  {
    super(anOperationName);
  }

  public OPInscripcionCCI(String anOperationName, Context aParentContext)
    throws IOException, DSEInvalidRequestException
  {
    super(anOperationName, aParentContext);
  }

  public OPInscripcionCCI(String anOperationName, String aParentContext)
    ...
    throws BbvaException
  {
    try
    {
      ...
      setValueAt("prTipoDocumento", getValueAt("TipoDocumento").toString());
      setValueAt("prNumeroDocumento", getValueAt("NumeroDocumento").toString());
