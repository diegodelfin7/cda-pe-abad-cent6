				...
				<div class="caja_tabla" style="width: 525px">
					<table>
						...
						<tr class="tr_gris">
							...
							<td class="td_der_blan"><%= request.getParameter("nombreEntidad")%></td>
						</tr>
						<tr class="tr_blanco">
							<td class="td_izq_color">NUMERO DE TARJETA</td>
							<td class="td_der_blan"><%= request.getParameter("numeroTarjeta")%></td>
						</tr>
						<!--Fecha Opeeración -->
						<tr class="tr_gris">
