				...
				<div class="caja_tabla" style="width: 525px">
					<table>
						...
						<tr class="tr_gris">
							...
							<td class="td_der_blan">&nbsp;<%= request.getParameter("numeroCuentaAbono")%>&nbsp;&nbsp;&nbsp;<%= request.getParameter("montoCuentaAbono")%></td>
						</tr>
						<tr class="tr_blanco">
							<td class="td_izq_color">Nombre  del Beneficiario</td>
							<td class="td_der_blan"><%= request.getParameter("nombreBeneficiario")%></td>
						</tr>
						<tr class="tr_gris">
							<td class="td_izq_color">Dirección del Beneficiario</td>
							<td class="td_der_blan"><%= request.getParameter("direccionBeneficiario")%></td>
						</tr>
						<tr class="tr_blanco">
							<td class="td_izq_color">Motivo</td>
							<td class="td_der_blan"><%= request.getParameter("motivoTransferencia")%></td>
						</tr>
						<tr class="tr_gris">
							<td class="td_izq_color">Nombre del Banco Pagador</td>
							<td class="td_der_blan"><%= request.getParameter("nombreBancoPagador")%></td>
						</tr>
						<tr class="tr_blanco">
							<td class="td_izq_color">Dirección Banco Pagador</td>
							<td class="td_der_blan"><%= request.getParameter("direccionBancoPagador")%></td>
						</tr>
						<!--Fecha Opeeración -->
						<tr class="tr_gris">
					...
					<table>
						...
						<tr class="tr_blanco">
							<td class="td_izq_color">Los días 15
								de cada mes
							</td>
						</tr>
					</table>
						...
						<tr>
							<td>
								<div id="contenedorTelefonos">
									<table style="width: 520px;">
										<tr class="tr_blanco">
											<td class="td_izq_color" colspan="2">Mensaje de Texto [SMS] a Teléfono Móvil<br>
												CLAIRO Lima-Callao 555555555</td>
										</tr>
									</table>
								</div>
							</td>
						...
						<tr>
							<td>
								<div id="contenedorEmail">
									<table style="width: 520px;">
										<tr class="tr_blanco">
											<td class="td_izq_color" colspan="2">Mensaje de correo a la dirección
												electrónica<br> EMAIL
					...
					<table>
						...
						<tr class="tr_gris">
							<td class="td_izq_color" colspan="2">Estimado Cliente, su operación ha sido efectuada
							</td>
						</tr>
						<tr class="tr_gris">
							<td class="td_izq_color" colspan="2">PAGO FRECUENTE le permitirá recordar los datos de esta operación en futuras transacciones
							</td>
						</tr>
					</table>
				</div>
