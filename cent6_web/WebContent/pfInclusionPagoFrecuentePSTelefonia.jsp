<form action="OperacionCBTFServlet?proceso=pfPagoFrecuentePSTelefonia_pr&operacion=pfInscripcionPSTelefonia_op&accion=inscribir" name="frmInscripcion" method="post">
<center>
