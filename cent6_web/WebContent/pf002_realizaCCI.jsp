			...
			<center>
				<div class="caja_tabla" style="width: 525px">
					<table>
						...
						<tr class="tr_gris">
							<td class="td_izq_color">Tipo y Nro Doc del Benef</td>
							<td class="td_der_blan">&nbsp;<%= request.getParameter("tipoDocumento")%>&nbsp;&nbsp;&nbsp;<%= request.getParameter("numeroDocumento")%></td>
						</tr>
						<!--Fecha Opeeración -->
						<tr class="tr_gris">
									...
									<table style="width: 520px;">
										<tr class="tr_blanco">
											<td class="td_izq_color" colspan="2">Mensaje de Texto [SMS] a Teléfono Móvil<br>
												CLAIRO Lima-Callao       55555555555</td>
										</tr>
									</table>
								</div>
							</td>
